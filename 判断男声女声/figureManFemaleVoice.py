#Reference: http://blog.csdn.net/u014365862/article/details/54600398
...
X = tf.placeholder(dtype=tf.float32, shape = [None, voice.shape[-1]])
...
def train_neural_network():
    ...
    with tf.Session() as sess:
        ...
        #summary_writer = tf.train.SummaryWriter('voice')
