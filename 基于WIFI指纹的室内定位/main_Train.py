# Reference£ºhttp://blog.csdn.net/u014365862/article/details/53868533
#data-Resource:https://archive.ics.uci.edu/ml/datasets/UJIIndoorLoc

import tensorflow as tf
from sklearn.processing import scale
import pandas as pd
import numpy as np

training_data = pd.read_csv("UJIndoorLoc\trainingData.csv", header = 0)
...
def train_neural_networks():
    ...
    with tf.Session() as sess:
        ...
        for b in range(training_epochs):
        ...
        for epoch in range(training_epochs):
            ...
            for b in range(total_batches):
                ...
                _, c = sess.run([us_optimizer, us_cost_function], feed_dict={X:batch_x, Y:batch_y})
                epoch_costs = np.append(epoch_costs,c)
